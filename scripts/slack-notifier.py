...
# Discord and email notifiers and the notify-alerts.py fan-out.
################################################################################

import argparse
import sys

from notifiers import NotificationError, Severity, SlackNotifier


def main() -> int:
    parser = argparse.ArgumentParser(description="Send honeypot notifications to Slack")
    ...
    parser.add_argument("--webhook", help="Slack webhook URL (default: $SLACK_WEBHOOK_URL)")
